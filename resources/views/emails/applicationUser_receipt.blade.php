...
@section('body')
        ...
        <tr>
            <td style="background-color:#ffffff; padding: 10px">
                ...
                <table class="force-full-width">
                    ...
                    <tr>
                        <th style="text-align: center; border: #088A9B solid 2px; color: white; background: #088A9B; padding: 5px ">
                            Nom
                        </th>
                        <th style="text-align: center; border: #088A9B solid 2px; color: white; background: #088A9B; padding: 5px ">
                            Quantité
                    ...
                    @foreach($orders as $order)
                        <tr>
                            ...
                            @if($orderInfo->HHStatus == 1)
                                <td style="text-align: center; border: #088A9B solid 2px; padding: 5px">{{ $order->itemHHPrice }}
                                    €
                                </td>
                            @else
                                <td style="text-align: center; border: #088A9B solid 2px; padding: 5px">{{ $order->itemPrice }}
                                    €
                                </td>
                            @endif
                            <td style="text-align: center; border: #088A9B solid 2px; padding: 5px">{{ $order->tax }}
                                %
                            </td>
                        </tr>
                    @endforeach
                    <tr>
                        ...
                        <th style="text-align: center; border: #088A9B solid 2px; color: white; background: #088A9B; padding: 5px "></th>
                        <th style="text-align: center; border: #088A9B solid 2px; color: white; background: #088A9B; padding: 5px "> {{ number_format($billAmount, 2) }}
                            €
                        </th>
                    </tr>
                </table>

                <p style="font-size: medium;font-style: italic; color: blue">Les notes partagées ont un surcoût de 20
                    centimes.</p>
                ...
                <table>
                    ...
                    <br><br>
                    <span class="bold">Adresse : </span>{{ $partner->address }} - {{ $partner->city }}
                    - {{ $partner->postalCode }}
    ...
    <table cellspacing="0" cellpadding="0" width="600" class="force-full-width">
        <tr>
            <td>
                <img src="{{$base_url}}img/emails/applicationUser_receipt/sipperUser_thanks_receipt.svg"
