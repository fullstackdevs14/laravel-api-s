                            ...
                            <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="hhtps://sipperapp.com"><img class="w320" width="311" height="83" src="http://sipper.pro/public/img/Sipper-logo.svg" alt="company logo" ></a>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="background-color:#088A9B;">
                                        ...
                                        <table cellspacing="0" cellpadding="0" class="force-full-width">
                                            <tr>
                                                <td style="font-size:40px; font-weight: 600; color: #ffffff; text-align:center;" class="mobile-spacing">
                                                    ...
                                                    Hello <?php echo e($sipperUser_name); ?> !
                                                    Tu as presque terminé!
                                                    <br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:34px; text-align:center; padding: 0 75px; color:#ffffff;" class="w320 mobile-spacing; ">
                                                    <?php echo link_to($url_token, 'Clique ici pour finaliser :)'); ?>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="600" class="force-full-width">
                                            <tr>
                                                <td>
                                                    <img src="http://sipper.pro/public/img/emails/email_confirmation/ordinateur_mail_inscription.svg" style="max-width:100%; display:block;">
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="columns" cellspacing="0" cellpadding="0" width="49%" align="right">
                                            <tr>
                                                <td class="column-padding" style="text-align:left; vertical-align:top; padding-left: 20px; padding-right:30px;">
                                                    <br>
                                                    <span style="color:#088A9B; font-size:20px; font-weight:bold;">Bienvenue dans l'équipe Sipper!</span><br>
                                                    Nous sommes actuellement entrain de travailler sur l'application. Tu pourras bientôt faire bien plus qu'il n'est déjà possible de faire aujourd'hui. En attendant nous te souhaitons un bon moment entre amis chez nos bars partenaires !
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table cellspacing="0" cellpadding="0" bgcolor="#363636"  class="force-full-width">
                                ...
                                <tr>
                                    <td style="color:#27aa90; font-size: 14px; text-align:center;">
                                        <a href="mailto:contact@sipperapp.com">Contact</a> <!--| <a href="#">Unsubscribe</a>-->
                                    </td>
                                </tr>
                                <tr>
